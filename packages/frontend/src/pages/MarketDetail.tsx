...
const LIGHT = {
  ...
  statsStrip:     'border-[rgba(62,44,30,0.12)] bg-[rgba(253,248,238,0.40)] backdrop-blur-md',
  statLabel:      'text-[rgba(35,24,18,0.45)]',
  statMu:         'text-[#C8102E]',
  statSigma:      'text-[#231812]',
  statLiq:        'text-[#231812]',
  chartCard:      'bg-[rgba(253,248,238,0.50)] backdrop-blur-md border-[rgba(62,44,30,0.12)]',
  ...
  ownerLabel:     'text-[#C8102E]',
  panelCard:      'bg-[rgba(253,248,238,0.55)] backdrop-blur-md border-[rgba(62,44,30,0.12)]',
  infoCard:       'border-[rgba(62,44,30,0.12)] bg-[rgba(253,248,238,0.40)] backdrop-blur-md',
